...
const QMetaObject QPresetEditorDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QPresetEditorDialog,
      qt_meta_data_QPresetEditorDialog, 0 }
};
...
int QPresetEditorDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: presetModified((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: buttonBoxHandler((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        case 2: saveFile(); break;
        case 3: saveAndNotify(); break;
        case 4: updateWindowTitle(); break;
        default: ;
        }
        _id -= 5;
    }
